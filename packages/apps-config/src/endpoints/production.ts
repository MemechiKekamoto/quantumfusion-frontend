...
export const prodChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'Ares Odyssey',
    providers: {
      // 'Ares Protocol': 'wss://odyssey.aresprotocol.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10411
    },
    text: 'Ares Odyssey',
    ui: {
      color: '#1295F0',
  ...
  },
  {
    info: 'centrifuge',
    providers: {
      // Centrifuge: 'wss://fullnode.centrifuge.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8012
    },
  ...
  },
  {
    ...
    providers: {
      ...
      // 'Republic Crypto | Runtime': 'wss://mainnet.cere-archive.republiccrypto-runtime.com:444' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9828
    },
    text: 'Cere Network',
    ui: {
      color: '#B7AEFF',
  ...
  },
  {
    ...
    providers: {
      // 'Competitors Club': 'wss://node0.competitors.club/wss' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8263
    },
  ...
  },
  {
    info: 'crown-sterling',
    providers: {
      // 'Crown Sterling': 'wss://blockchain.crownsterling.io' https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10289
    },
    text: 'Crown Sterling',
    ui: {
      color: '#13264b',
  ...
  },
  {
    info: 'debio',
    providers: {
      // DeBio: 'wss://ws-rpc.debio.network', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10118
  ...
  },
  {
    info: 'edgeware',
    providers: {
      // 'Commonwealth Labs': 'wss://mainnet2.edgewa.re', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10373
      ...
      // OnFinality: 'wss://edgeware.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9795
    },
    text: 'Edgeware',
    ui: {
      color: '#111111',
  ...
  },
  {
    info: 'efinity',
    providers: {
      // Efinity: 'wss://rpc.efinity.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/6761
    },
    text: 'Efinity',
    ui: {
      color: '#496ddb',
  ...
  },
  {
    info: 'fragnova',
    providers: {
      // 'Fragnova Network': 'wss://ws.fragnova.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
    },
  ...
  },
  {
    info: 'hanonycash',
    providers: {
      // Hanonycash: 'wss://rpc.hanonycash.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/runs/2755409009?check_suite_focus=true
    },
    text: 'Hanonycash',
    ui: {
      color: '#0099CC',
  ...
  },
  {
    info: 'innovatorchain',
    providers: {
      // Innovator: 'wss://rpc.innovatorchain.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10373
    },
  ...
  },
  {
    info: 'jur',
    providers: {
      // 'Iceberg Nodes': 'wss://jur-mainnet-archive-rpc-1.icebergnodes.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10289
      // 'Simply Staking': 'wss://jur-archive-mainnet-1.simplystaking.xyz/VX68C07AR4K2/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
    },
    text: 'Jur',
    ui: {
      color: '#203050',
  ...
  },
  {
    info: 'kusari',
    providers: {
      // Swapdex: 'wss://ws.kusari.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9712
    },
    text: 'Kusari',
    ui: {
      color: '#b8860b',
  ...
  },
  {
    info: 'logion',
    providers: {
      // 'Logion 1': 'wss://rpc01.logion.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
    },
  ...
  },
  {
    info: 'mathchain',
    providers: {
      //  MathWallet: 'wss://mathchain-asia.maiziqianbao.net/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8525
      // 'MathWallet Backup': 'wss://mathchain-us.maiziqianbao.net/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8525
    },
    text: 'MathChain',
    ui: {
      color: '#000000',
  ...
  },
  {
    info: 'minix',
    providers: {
      // ChainX: 'wss://minichain-mainnet.coming.chat/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/7182
    },
    text: 'MiniX',
    ui: {
      color: '#5152f7',
  ...
  },
  {
    info: 'myriad',
    providers: {
      // Myriad: 'wss://ws-rpc.myriad.social', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
  ...
  },
  {
    info: 'nodle',
    providers: {
      // Nodle: 'wss://main3.nodleprotocol.io', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/7652
      // OnFinality: 'wss://nodle.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8013
    },
    text: 'Nodle',
    ui: {
      color: '#1ab394',
  ...
  },
  {
    info: 'riochain',
    providers: {
      // RioChain: 'wss://node.v1.riochain.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9054
    },
    text: 'RioChain',
    ui: {
  ...
  },
  {
    info: 'robonomics',
    providers: {
      // Airalab: 'wss://kusama.rpc.robonomics.network/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/6761
    },
    text: 'Robonomics',
    ui: {
      color: '#2949d3',
  ...
  },
  {
    info: 'sherpax',
    providers: {
      // ChainX: 'wss://mainnet.sherpax.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9712
    },
    text: 'SherpaX',
    ui: {
      color: '#6bbee8',
  ...
  },
  {
    info: 'spanner',
    providers: {
      // Spanner: 'wss://wss.spannerprotocol.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6547
    },
    text: 'Spanner',
    ui: {
      color: '#EC3D3D',
  ...
  },
  {
    info: 'subgame',
    providers: {
      // SubGame: 'wss://mainnet.subgame.org/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9030
    },
    text: 'SubGame',
    ui: {
      color: '#EB027D',
  ...
  },
  {
    info: 'subsocial',
    providers: {
      // DappForce: 'wss://rpc.subsocial.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8046
    },
    text: 'Subsocial',
    ui: {
      color: '#b9018c',
  ...
  },
  {
    info: 'swapdex',
    providers: {
      // Swapdex: 'wss://ws.swapdex.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10030
    },
    text: 'Swapdex',
    ui: {
      color: '#E94082',
  ...
  },
  {
    info: 'ternoa',
    providers: {
      CapsuleCorp: 'wss://mainnet.ternoa.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
    },
    text: 'Ternoa',
    ui: {
      color: '#d622ff',
  ...
  },
  {
    info: 'uniarts',
    providers: {
      // UniArts: 'wss://mainnet.uniarts.vip:9443' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
    text: 'UniArts',
    ui: {
  ...
  },
  {
    info: 'westlake',
    providers: {
      // DataHighway: 'wss://westlake.datahighway.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/7293
    },
    text: 'Westlake',
    ui: {
