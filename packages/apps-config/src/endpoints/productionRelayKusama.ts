...
export const prodParasKusama: Omit<EndpointOption, 'teleport'>[] = [
  {
    ...
    paraId: 2257,
    providers: {
      // 'Aband DAO': 'wss://rpc-parachain.a.band' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9334
    },
    text: 'Aband',
    ui: {
      color: '#7358ff',
  ...
  },
  {
    ...
    paraId: 2239,
    providers: {
      // Acurast: 'wss://acurast-canarynet-ws.prod.gke.papers.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
    },
    text: 'Acurast Canary',
    ui: {
      color: '#000000',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://basilisk.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9414
    },
    text: 'Basilisk',
    ui: {
      color: '#49E49F',
  ...
  },
  {
    ...
    providers: {
      ...
      // 'Darwinia Community': 'wss://crab-rpc.darwiniacommunitydao.xyz', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10663
  ...
  },
  {
    ...
    providers: {
      ...
      // Crust: 'wss://rpc-shadow.crust.network/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8355
    },
    text: 'Crust Shadow 2',
    ui: {
      logo: nodesShadowSVG
  ...
  },
  {
    ...
    paraId: 2115,
    providers: {
      // DORA: 'wss://kusama.dorafactory.org' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9748
    },
    text: 'Dora Factory',
    ui: {
      color: '#FF761C',
  ...
  },
  {
    ...
    paraId: 2024,
    providers: {
      // Genshiro: 'wss://node.genshiro.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10174
    },
    text: 'Genshiro',
    ui: {
      color: '#e8662d',
  ...
  },
  {
    ...
    paraId: 2226,
    providers: {
      // Equilibrium: 'wss://node.genshiro.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10174
    },
  ...
  },
  {
    ...
    paraId: 2123,
    providers: {
      // GMorDieDAO: 'wss://kusama.gmordie.com', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8457
      // 'GM Intern': 'wss://intern.gmordie.com', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9381
      // TerraBioDAO: 'wss://ws-node-gm.terrabiodao.org', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8867
      // Leemo: 'wss://leemo.gmordie.com', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9712
      // 'bLd Nodes': 'wss://ws.gm.bldnodes.org', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9947
  ...
  },
  {
    ...
    paraId: 3340,
    providers: {
      // BlockOps: 'wss://hyperbridge-messier-rpc.blockops.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10555
    },
  ...
  },
  {
    ...
    providers: {
      ...
      // 'Imbue Network 1': 'wss://collator.production.imbue.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9848
    },
    text: 'Imbue Network',
    ui: {
      color: '#baff36',
  ...
  },
  {
    ...
    paraId: 2125,
    providers: {
      // 'InvArch Team': 'wss://tinker.invarch.network', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8623
      Dwellir: 'wss://tinkernet-rpc.dwellir.com',
      // OnFinality: 'wss://invarch-tinkernet.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9955
  ...
  },
  {
    ...
    providers: {
      ...
      // LuckyFriday: 'wss://rpc-karura.luckyfriday.io',  // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10663
      OnFinality: 'wss://karura.api.onfinality.io/public-ws'
      // 'Polkawallet 0': 'wss://karura.polkawallet.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9383
    },
    text: 'Karura',
    ui: {
      color: '#ff4c3b',
  ...
  },
  {
    ...
    providers: {
      ...
      // RadiumBlock: 'wss://khala.public.curie.radiumblock.co/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10663
  ...
  },
  {
    ...
    paraId: 2107,
    providers: {
      // 'DICO Foundation': 'wss://rpc.kico.dico.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9266
      // 'DICO Foundation 2': 'wss://rpc.api.kico.dico.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8203
    },
    text: 'KICO',
    ui: {
      color: '#29B58D',
  ...
  },
  {
    ...
    paraId: 2235,
    providers: {
      // 'DICO Foundation': 'wss://rpc.kico2.dico.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8415
    },
    text: 'KICO 2',
    ui: {
      color: '#29B58D',
  ...
  },
  {
    ...
    providers: {
      ...
      // LuckyFriday: 'wss://rpc-kintsugi.luckyfriday.io/', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9947
  ...
  },
  {
    ...
    paraId: 2118,
    providers: {
      // 'Listen Foundation 1': 'wss://rpc.mainnet.listen.io', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9069
      // 'Listen Foundation 2': 'wss://wss.mainnet.listen.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9106
    },
    text: 'Listen Network',
    ui: {
      color: '#FFAD0A',
  ...
  },
  {
    ...
    paraId: 2080,
    providers: {
      // LoomNetwork: 'wss://kusama.dappchains.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/5888
    },
    text: 'Loom Network',
    ui: {
  ...
  },
  {
    ...
    paraId: 2008,
    providers: {
      // AresProtocol: 'wss://wss.mars.aresprotocol.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8937
    },
    text: 'Mars',
    ui: {
      color: '#E56239',
  ...
  },
  {
    ...
    paraId: 2085,
    providers: {
      // OnFinality: 'wss://parallel-heiko.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9964
  ...
  },
  {
    ...
    providers: {
      ...
      // LuckyFriday: 'wss://rpc-picasso.luckyfriday.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9947
    },
    text: 'Picasso',
    ui: {
      color: '#000000',
  ...
  },
  {
    ...
    paraId: 2102,
    providers: {
      // 'Kylin Network': 'wss://kusama.kylin-node.co.uk' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9560
    },
    text: 'Pichiu',
    ui: {
      color: '#ed007e',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://pioneer.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9955
    },
    text: 'Pioneer',
    ui: {
      color: '#000000',
  ...
  },
  {
    ...
    paraId: 2009,
    providers: {
      // PolkaSmith: 'wss://wss-polkasmith.polkafoundry.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6595
    },
  ...
  },
  {
    ...
    paraId: 2274,
    providers: {
      // FerrumNetwork: 'wss://qpn.svcs.ferrumnetwork.io/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
    },
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://quartz.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9972
  ...
  },
  {
    ...
    paraId: 2227,
    providers: {
      // RioProtocol: 'wss://rio-kusama.riocorenetwork.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9261
    },
    text: 'RioDeFi',
    ui: {
      color: '#4E7AED',
  ...
  },
  {
    ...
    providers: {
      ...
      // Leemo: 'wss://robonomics.leemo.me', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9817
      // OnFinality: 'wss://robonomics.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9824
  ...
  },
  {
    ...
    paraId: 2129,
    providers: {
      // IceNetwork: 'wss://snow-rpc.icenetwork.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9405
    },
    text: 'SNOW Network',
    ui: {
      logo: nodesSnowPNG
  ...
  },
  {
    ...
    paraId: 2018,
    providers: {
      // SubGame: 'wss://gamma.subgame.org/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/7982
    },
    text: 'SubGame Gamma',
    ui: {
      color: '#EB027D',
  ...
  },
  {
    ...
    paraId: 3334,
    providers: {
      // t3rn: 'wss://rpc.t1rn.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10091
    },
    text: 't1rn',
    ui: {
      color: '#131532',
  ...
  },
  {
    ...
    paraId: 2116,
    providers: {
      // DataHighway: 'wss://tanganika.datahighway.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9383
    },
    text: 'Tanganika',
    ui: {
  ...
  },
  {
    ...
    paraId: 2094,
    providers: {
      // 'Standard Protocol': 'wss://rpc.kusama.standard.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8525
    },
    text: 'Unorthodox',
    ui: {
...
export const prodParasKusamaCommon: EndpointOption[] = [
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://encointer.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
...
export const prodRelayKusama: EndpointOption = {
  ...
  providers: {
    // 'Geometry Labs': 'wss://kusama.geometry.io/websockets', // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/6746
    // 'Automata 1RPC': 'wss://1rpc.io/ksm',
    Allnodes: 'wss://kusama-rpc.publicnode.com',
    Blockops: 'wss://kusama-public-rpc.blockops.network/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9840
