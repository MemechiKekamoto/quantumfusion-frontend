...
export const prodParasPolkadot: Omit<EndpointOption, 'teleport'>[] = [
  {
    ...
    providers: {
      ...
      // 'Acala Foundation 2': 'wss://acala-rpc-2.aca-api.network/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6965
      'Acala Foundation 3': 'wss://acala-rpc-3.aca-api.network/ws',
      Dwellir: 'wss://acala-rpc.dwellir.com',
      LuckyFriday: 'wss://rpc-acala.luckyfriday.io',
      // 'Automata 1RPC': 'wss://1rpc.io/aca' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8648
      OnFinality: 'wss://acala-polkadot.api.onfinality.io/public-ws'
      // 'Polkawallet 0': 'wss://acala.polkawallet.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9760
    },
    text: 'Acala',
    ui: {
      color: '#645AFF',
  ...
  },
  {
    ...
    providers: {
      ...
      // RadiumBlock: 'wss://ajuna.public.curie.radiumblock.co/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10663
    },
    text: 'Ajuna Network',
    ui: {
      color: '#161212',
  ...
  },
  {
    ...
    paraId: 2028,
    providers: {
      // AresProtocol: 'wss://wss.odyssey.aresprotocol.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
    text: 'Ares Odyssey',
    ui: {
      color: '#1295F0',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://bitgreen.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9993
    },
    text: 'Bitgreen',
    ui: {
      color: '#224851',
  ...
  },
  {
    ...
    paraId: 2002,
    providers: {
      // Clover: 'wss://rpc-para.clover.finance' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10172
      // OnFinality: 'wss://clover.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
    },
    text: 'Clover',
    ui: {
  ...
  },
  {
    ...
    paraId: 2027,
    providers: {
      // Coinversation: 'wss://rpc.coinversation.io/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6635
    },
    text: 'Coinversation',
    ui: {
      color: '#e6017a',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://composable.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
    },
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://crust-polkadot.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10013
    },
    text: 'Crust',
    ui: {
  ...
  },
  {
    ...
    providers: {
      ...
      // 'Darwinia Community': 'wss://darwinia-rpc.darwiniacommunitydao.xyz', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
      Dwellir: 'wss://darwinia-rpc.dwellir.com'
      // OnFinality: 'wss://darwinia2.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9861
    },
    text: 'Darwinia',
    ui: {
      color: '#FF0083',
  ...
  },
  {
    ...
    providers: {
      ...
      // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/9555/files#r1225095086
    },
    text: 'Efinity',
    ui: {
      color: '#496ddb',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://equilibrium.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9977
      // Equilibrium: 'wss://node.equilibrium.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10174
    },
    text: 'Equilibrium',
    ui: {
      color: '#1792ff',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://hydradx.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
      // ZeePrime: 'wss://rpc-lb.data6.zp-labs.net:8443/hydradx/ws/?token=2ZGuGivPJJAxXiT1hR1Yg2MXGjMrhEBYFjgbdPi' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9760
    },
    text: 'HydraDX',
    ui: {
      color: '#f653a2',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://interlay.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
    },
    text: 'Interlay',
    ui: {
      color: '#3E96FF',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://kapex-parachain.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
      // Totem: 'wss://k-ui.kapex.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9616
    },
    text: 'Kapex',
    ui: {
  ...
  },
  {
    ...
    paraId: 2052,
    providers: {
      // 'Kylin Network': 'wss://polkadot.kylin-node.co.uk' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10030
    },
    text: 'Kylin',
    ui: {
      color: '#ed007e',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://litentry.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9993
    },
    text: 'Litentry',
    ui: {
      color: '#15B786',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://manta.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9977
    },
    text: 'Manta',
    ui: {
      color: '#2070a6',
  ...
  },
  {
    ...
    providers: {
      ...
      // 'Automata 1RPC': 'wss://1rpc.io/glmr', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10566
  ...
  },
  {
    ...
    paraId: 3334,
    providers: {
      // Moonsama: 'wss://rpc.moonsama.com/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10289
    },
    text: 'Moonsama',
    ui: {
      color: '#1a202c',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://parallel.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9986
      // Parallel: 'wss://polkadot-parallel-rpc.parallel.fi' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10220
    },
    text: 'Parallel',
    ui: {
      color: '#ef18ac',
  ...
  },
  {
    ...
    paraId: 2017,
    providers: {
      // SubGame: 'wss://gamma.subgame.org/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/6761
    },
    text: 'SubGame Gamma',
    ui: {
      color: '#EB027D',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://subsocial-polkadot.api.onfinality.io/public-ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9977
    },
    text: 'Subsocial',
    ui: {
      color: '#b9018c',
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://unique.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10030
...
export const prodParasPolkadotCommon: EndpointOption[] = [
  {
    ...
    providers: {
      ...
      // IBP1: 'wss://sys.ibp.network/statemint', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
...
export const prodRelayPolkadot: EndpointOption = {
  ...
  providers: {
    ...
    // 'Geometry Labs': 'wss://polkadot.geometry.io/websockets', // https://github.com/MemechiKekamoto/quantumfusion-frontend/pull/6746
    // 'Automata 1RPC': 'wss://1rpc.io/dot',
    Blockops: 'wss://polkadot-public-rpc.blockops.network/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9840
