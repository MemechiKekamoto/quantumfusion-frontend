...
export const testParasRococo: Omit<EndpointOption, 'teleport'>[] = [
  {
    ...
    paraId: 2239,
    providers: {
      // Acurast: 'wss://acurast-testnet-ws.prod.gke.papers.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10566
    },
  ...
  },
  {
    ...
    paraId: 3015,
    providers: {
      // Arctic: 'wss://arctic-rococo-rpc.icenetwork.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9224
    },
    text: 'Arctic',
    ui: {
      logo: nodesArcticPNG
  ...
  },
  {
    ...
    paraId: 20048,
    providers: {
      // Bitgreen: 'wss://staging.bitgreen.org' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9369
    },
    text: 'Bitgreen',
    ui: {
      color: '#224851',
  ...
  },
  {
    ...
    paraId: 2031,
    providers: {
      // Centrifuge: 'wss://fullnode.catalyst.cntrfg.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9748
    },
    text: 'Catalyst',
    ui: {
  ...
  },
  {
    ...
    paraId: 4094,
    providers: {
      // Confti: 'wss://ws.confti.club' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8036
    },
    text: 'Confti',
    ui: {
      logo: nodesConftiSVG
  ...
  },
  {
    ...
    paraId: 2012,
    providers: {
      // Crust: 'wss://rococo-csm.crustcode.com/' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9025
    },
    text: 'Crust Testnet',
    ui: {
  ...
  },
  {
    ...
    paraId: 2084,
    providers: {
      // 'Manta Network': 'wss://ws.rococo.dolphin.engineering' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9071
    },
    text: 'Dolphin',
    ui: {
  ...
  },
  {
    ...
    paraId: 2095,
    providers: {
      // Jur: 'wss://ethos.jur.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10025
    },
    text: 'Ethos',
    ui: {
      color: '#203050',
  ...
  },
  {
    ...
    paraId: 2024,
    providers: {
      // Equilibrium: 'wss://parachain-testnet.equilab.io/rococo/collator/node1/wss' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
  ...
  },
  {
    ...
    paraId: 4227,
    providers: {
      // GIANT: 'wss://rpc-1-us-east-1-testnetrococo.giantprotocol.org' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9261
    },
    text: 'GIANT Protocol',
    ui: {
      color: '#45B549',
  ...
  },
  {
    ...
    paraId: 3025,
    providers: {
      // Helixstreet: 'wss://rpc-rococo.helixstreet.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9296
    },
    text: 'Helixstreet',
    ui: {
  ...
  },
  {
    ...
    paraId: 2034,
    providers: {
      // 'Galactic Council': 'wss://hydradx-rococo-rpc.play.hydration.cloud' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
    },
    text: 'HydraDX',
    ui: {
      color: '#f653a2',
  ...
  },
  {
    ...
    paraId: 4374,
    providers: {
      // BlockOps: 'wss://hyperbridge-gargantua-rpc.blockops.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10667
    },
  ...
  },
  {
    ...
    paraId: 4222,
    providers: {
      // 'Anagolay Network': 'wss://rococo.rpc.idiyanale.anagolay.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9292
    },
  ...
  },
  {
    ...
    paraId: 2121,
    providers: {
      // 'Imbue Network': 'wss://rococo.imbue.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9947
    },
    text: 'Imbue Network',
    ui: {
      color: '#baff36',
  ...
  },
  {
    ...
    paraId: 3002,
    providers: {
      // Integritee: 'wss://rococo.api.integritee.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10353
    },
  ...
  },
  {
    ...
    paraId: 4377,
    providers: {
      // 'Invo Network': 'wss://chain.dev.ourinvo.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10555
    },
    text: 'Invo Testnet',
    ui: {
      color: '#000000',
  ...
  },
  {
    ...
    paraId: 2113,
    providers: {
      // JelliedOwl: 'wss://kabsoup1.jelliedowl.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
  ...
  },
  {
    ...
    paraId: 2040,
    providers: {
      // 'Polkadex Team': 'wss://kaizen-parachain.polkadex.trade' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
    text: 'Kaizen',
    ui: {
      color: '#7C30DD',
  ...
  },
  {
    ...
    paraId: 2055,
    providers: {
      // Moonsama: 'wss://moonsama-testnet-rpc.moonsama.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/7526
    },
    text: 'Moonsama',
    ui: {
      color: '#000000',
  ...
  },
  {
    ...
    paraId: 2087,
    providers: {
      // Composable: 'wss://picasso-rococo-rpc-lb.composablenodes.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10103
    },
  ...
  },
  {
    ...
    paraId: 2048,
    providers: {
      // Airalab: 'wss://rococo.rpc.robonomics.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9319
    },
    text: 'Robonomics',
    ui: {
      color: '#2949d3',
  ...
  },
  {
    ...
    paraId: 2021,
    providers: {
      // Efinity: 'wss://rpc.rococo.efinity.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9059
    },
    text: 'Rocfinity',
    ui: {
      color: '#496ddb',
  ...
  },
  {
    ...
    paraId: 3416,
    providers: {
      // Snowfork: 'wss://rococo-rpc.snowbridge.network/assethub' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10091
    },
  ...
  },
  {
    ...
    paraId: 3016,
    providers: {
      // Snowfork: 'wss://rococo-rpc.snowbridge.network/bridgehub' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10091
    },
  ...
  },
  {
    ...
    paraId: 4253,
    providers: {
      // Societal: 'wss://node-ws-rococo.testnet.sctl.link' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9748
    },
    text: 'Societal',
    ui: {
      color: '#501254',
  ...
  },
  {
    ...
    paraId: 2116,
    providers: {
      // DataHighway: 'wss://spreehafen.datahighway.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9601
    },
    text: 'Spreehafen',
    ui: {
  ...
  },
  {
    ...
    paraId: 2007,
    providers: {
      // Totem: 'wss://s-ui.kapex.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9286
    },
    text: 'Stagex',
    ui: {
  ...
  },
  {
    ...
    paraId: 4040,
    providers: {
      // ZERO: 'wss://staging.para.sub.zero.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9522
    },
    text: 'Subzero',
    ui: {
      logo: nodesZeroSVG
  ...
  },
  {
    ...
    paraId: 2125,
    providers: {
      // 'InvArch Team': 'wss://rococo.invarch.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8266
    },
    text: 'Tinkernet',
    ui: {
  ...
  },
  {
    ...
    paraId: 2114,
    providers: {
      // OAK: 'wss://rpc.turing-staging.oak.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/10555
    },
  ...
  },
  {
    ...
    paraId: 4168,
    providers: {
      // UnitNetwork: 'wss://www.unitnode3.info:443' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9609
    },
    text: 'Unit Network',
    ui: {
      color: '#a351ef',
  ...
  },
  {
    ...
    paraId: 3003,
    providers: {
      // VirtoNetwork: 'wss://rococo.virtonetwork.xyz' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8024
    },
    text: 'Virto',
    ui: {
      color: '#063970',
...
export const testRelayRococo: EndpointOption = {
  ...
  providers: {
    ...
    // 'Ares Protocol': 'wss://rococo.aresprotocol.com' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/5767
