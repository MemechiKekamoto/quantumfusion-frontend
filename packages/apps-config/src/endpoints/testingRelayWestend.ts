...
export const testParasWestend: Omit<EndpointOption, 'teleport'>[] = [
  {
    ...
    paraId: 2086,
    providers: {
      // Centrifuge: 'wss://fullnode-collator.charcoal.centrifuge.io' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8219
    },
    text: 'Charcoal',
    ui: {
  ...
  },
  {
    ...
    paraId: 2081,
    providers: {
      // Integritee: 'wss://teerw1.integritee.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8937
    },
  ...
  },
  {
    ...
    paraId: 2094,
    providers: {
      // Interlay: 'wss://api-westend.interlay.io/parachain' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6261
    },
    text: 'Interlay',
    ui: {
  ...
  },
  {
    ...
    paraId: 2002,
    providers: {
      // PureStake: 'wss://wss.moonshadow.testnet.moonbeam.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6181
    },
    text: 'Moonshadow',
    ui: {
      color: '#53cbc9',
  ...
  },
  {
    ...
    paraId: 2112,
    providers: {
      // 'Kylin Network': 'wss://westend.kylin-node.co.uk' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8710
    },
    text: 'Pichiu',
    ui: {
      logo: nodesKylinPNG
  ...
  },
  {
    ...
    paraId: 2094,
    providers: {
      // 'Standard Protocol': 'wss://rpc.westend.standard.tech' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/8525
    },
    text: 'Standard',
    ui: {
  ...
  },
  {
    ...
    paraId: 2005,
    providers: {
      // 'Acala Foundation': 'wss://karura-westend-rpc.aca-staging.network' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/5830
    },
    text: 'Wendala',
    ui: {
  ...
  },
  {
    ...
    paraId: 2013,
    providers: {
      // Phala: 'wss://whala.phala.network/ws' // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/6181
    },
    text: 'Whala',
    ui: {
      color: '#03f3f3',
...
export const testParasWestendCommon: EndpointOption[] = [
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://westmint.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9955
  ...
  },
  {
    ...
    providers: {
      ...
      // OnFinality: 'wss://bridgehub-westend.api.onfinality.io/public-ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9960
...
export const testRelayWestend: EndpointOption = {
  ...
  providers: {
    Blockops: 'wss://westend-rpc.blockops.network/ws', // https://github.com/MemechiKekamoto/quantumfusion-frontend/issues/9840
